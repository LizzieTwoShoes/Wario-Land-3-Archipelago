...
def add_rule(location_dict, rule_id, *fns) -> None:
    new = _o(*fns)
...
COIN_RULES: dict = {
    "Out of the Woods": [
        ...
        _o(has_flippers_1, has_storm_pouch, can_fly),                                   #4
        can_jump_high,                                                                  #5
        None,                                                                           #6
...
def set_rules(world: "WL3World") -> None:
    ...
    if world.options.enemizer:
        add_rule(coin_logic["Out of the Woods"], 1, _has("Fire Form"), can_pound_solid_blocks)
        add_rule(coin_logic["Out of the Woods"], 4, can_bounce)
        add_rule(coin_logic["Out of the Woods"], 6, _has("Flat Form"), _has("Roll Form"))
        ...
        add_rule(chest_logic["The Vast Plain"], green, _has("Invisible Form"))
        add_rule(chest_logic["The Vast Plain"], blue, _has("Invisible Form"))
        add_rule(key_logic["The Vast Plain"], grey, _has("Invisible Form"))
        add_rule(key_logic["The Vast Plain"], green, _has("Invisible Form"))
        add_rule(key_logic["The Vast Plain"], blue, _has("Invisible Form"))
        add_rule(coin_logic["The Vast Plain"], 1, _has("Invisible Form"))
        add_rule(coin_logic["The Vast Plain"], 2, _c(_has("Invisible Form"), can_pass_spikes))
        add_rule(coin_logic["The Vast Plain"], 3, _has("Puffy Form"))
        add_rule(coin_logic["The Vast Plain"], 4, _has("Invisible Form"))
        add_rule(coin_logic["The Vast Plain"], 5, _has("Invisible Form"))
        add_rule(coin_logic["The Vast Plain"], 6, _c(_has("Invisible Form"), _o(_has("Zombie Form"), can_fly)))
        add_rule(coin_logic["The Vast Plain"], 7, _c(_has("Invisible Form"), can_fly))
        add_rule(chest_logic["Bank of the Wild River"], blue, _has("Fire Form"))
        add_rule(key_logic["Bank of the Wild River"], blue, can_fly)
        add_rule(coin_logic["Bank of the Wild River"], 0, can_fly)
        add_rule(coin_logic["Bank of the Wild River"], 4, can_kill_frogs)
        add_rule(coin_logic["Bank of the Wild River"], 5, _has("Fire Form"))
        add_rule(coin_logic["Bank of the Wild River"], 7, _c(can_kill_frogs, _o(can_fly,_has("High Jump Boots"))))
        add_rule(chest_logic["The Tidal Coast"], grey, _has("Fire Form"))
        add_rule(coin_logic["The Tidal Coast"], 0, can_bounce)
        # add_tf(coin_logic["The Tidal Coast"], 1, can_fly, _has("Flat Form")) # uncomment if omodonmeka are randomized
        add_rule(coin_logic["The Tidal Coast"], 3, can_bounce)
        add_rule(chest_logic["Sea Turtle Rocks"], red, _has("Fat Form"))
        add_rule(key_logic["Sea Turtle Rocks"], red, _has("Fat Form"))
        add_rule(chest_logic["Desert Ruins"], green, _has("Yarn Form"))
        add_rule(chest_logic["Desert Ruins"], blue, can_fly) 
        add_rule(key_logic["Desert Ruins"], blue, can_fly) 
        add_rule(coin_logic["Desert Ruins"], 2, can_bounce) 
        add_rule(coin_logic["Desert Ruins"], 3, _has("Bouncy Form"), _has("High Jump Boots")) 
        add_rule(coin_logic["The Volcano's Base"], 6, can_fly) 
        add_rule(coin_logic["The Volcano's Base"], 7, can_fly) 
        add_rule(coin_logic["The Pool of Rain"], 7, can_fly)
        add_rule(chest_logic["The Pool of Rain"], blue, can_fly)
        add_rule(chest_logic["A Town in Chaos"], red, _has("Zombie Form")) 
        add_rule(chest_logic["A Town in Chaos"], green, can_fly) 
        add_rule(key_logic["A Town in Chaos"], green, _has("Fat Form"))
        add_rule(coin_logic["A Town in Chaos"], 3, _has("Zombie Form"), can_bounce)
        add_rule(coin_logic["A Town in Chaos"], 7, _has("Bouncy Form"), _has("Puffy Form"))
        add_rule(chest_logic["Beneath the Waves"], green, _has("Yarn Form"), _has("Roll Form"))
        add_rule(chest_logic["Beneath the Waves"], blue, _has("Fat Form"))
        add_rule(coin_logic["Beneath the Waves"], 4, can_pass_spikes, can_fly)
        add_rule(coin_logic["Beneath the Waves"], 5, can_bounce)
        add_rule(coin_logic["Beneath the Waves"], 6, can_bounce)
        add_rule(coin_logic["Beneath the Waves"], 7, can_bounce)
        add_rule(chest_logic["The West Crater"], grey, _has("Yarn Form"), _c(_has("Rust Spray"), can_pound_cracked_blocks))
        add_rule(coin_logic["The West Crater"], 0, can_bounce)
        add_rule(coin_logic["The West Crater"], 1, _has("Yarn Form"), _c(_has("Rust Spray"), can_pound_cracked_blocks))
        add_rule(coin_logic["The West Crater"], 3, _has("Fat Form"))
        add_rule(key_logic["The Grasslands"], grey, _has("Flat Form"), can_bounce)
        add_rule(chest_logic["The Grasslands"], blue, _has("Yarn Form"))
        add_rule(key_logic["The Grasslands"], blue, can_bounce)
        add_rule(coin_logic["The Grasslands"], 2, _has("Zombie Form"), can_fly) 
        add_rule(coin_logic["The Grasslands"], 3, _c(can_bounce,_has("Yarn Form")))
        add_rule(coin_logic["The Grasslands"], 4, _c(can_bounce,_has("Yarn Form")))
        add_rule(coin_logic["The Grasslands"], 6, can_bounce)
        add_rule(coin_logic["The Big Bridge"], 6, can_fly) 
        add_rule(coin_logic["The Big Bridge"], 7, can_fly) 
        add_rule(chest_logic["The Steep Canyon"], red, can_fly)
        add_rule(chest_logic["The Steep Canyon"], green, can_fly)
        add_rule(key_logic["The Steep Canyon"], red, can_fly)
        add_rule(key_logic["The Steep Canyon"], green, can_fly)
        add_rule(coin_logic["The Steep Canyon"], 2, can_fly)
        add_rule(coin_logic["The Steep Canyon"], 3, can_fly)
        add_rule(coin_logic["The Steep Canyon"], 4, can_fly)
        add_rule(coin_logic["The Steep Canyon"], 5, can_fly)
        add_rule(chest_logic["Cave of Flames"], red, _c(can_bounce, _o(_has("Flat Form"), has_flippers_2, _has("Roll Form")), _has("Fat Form")))
        add_rule(chest_logic["Cave of Flames"], green, _has("Invisible Form"), _has("Zombie Form"))
        add_rule(chest_logic["Cave of Flames"], blue, can_bounce)
        add_rule(key_logic["Cave of Flames"], red, can_bounce)
        add_rule(key_logic["Cave of Flames"], green, _has("Invisible Form"))
        add_rule(key_logic["Cave of Flames"], blue, can_bounce)
        add_rule(coin_logic["Cave of Flames"], 0, can_bounce)
        add_rule(coin_logic["Cave of Flames"], 1, can_bounce)
        add_rule(coin_logic["Cave of Flames"], 3, _c(can_bounce, _o(has_flippers_2, _has("Flat Form"), _has("Roll Form"))))
        add_rule(coin_logic["Cave of Flames"], 4, _has("Bouncy Form"))
        add_rule(coin_logic["Cave of Flames"], 5, can_bounce)
        add_rule(coin_logic["Cave of Flames"], 6, can_bounce)
        add_rule(coin_logic["Cave of Flames"], 7, can_bounce)
        add_rule(chest_logic["Above the Clouds"], green, _has("Zombie Form"))
        add_rule(chest_logic["Above the Clouds"], blue, can_bounce, _has ("Roll Form"))
        add_rule(coin_logic["Above the Clouds"], 6, _has("Zombie Form"))
        add_rule(coin_logic["Above the Clouds"], 7, _has("Zombie Form"))
        add_rule(chest_logic["The Stagnant Swamp"], blue, can_fly)
        add_rule(key_logic["The Stagnant Swamp"], green, can_bounce)
        add_rule(key_logic["The Stagnant Swamp"], blue, can_fly)
        add_rule(coin_logic["The Stagnant Swamp"], 6, can_fly)
        add_rule(coin_logic["The Stagnant Swamp"], 7, can_bounce)
        add_rule(chest_logic["The Frigid Sea"], red, _has("Snowman Form")) # remove if snow drops aren't randomized
        add_rule(key_logic["The Frigid Sea"], blue, _has("Snowman Form")) # remove if snow drops aren't randomized
        add_rule(coin_logic["The Frigid Sea"], 2, _has("Snowman Form")) # remove if snow drops aren't randomized
        add_rule(coin_logic["The Frigid Sea"], 7, _has("Snowman Form")) # remove if snow drops aren't randomized
        add_rule(key_logic["Castle of Illusions"], red, can_bounce)
        add_rule(key_logic["Castle of Illusions"], green, can_bounce)
        add_rule(coin_logic["Castle of Illusions"], 0, _has("Zombie Form"), can_fly)
        add_rule(coin_logic["Castle of Illusions"], 1, can_bounce)
        add_rule(coin_logic["Castle of Illusions"], 2, can_bounce)
        add_rule(coin_logic["Castle of Illusions"], 3, can_bounce)
        add_rule(coin_logic["Castle of Illusions"], 4, can_bounce)
        add_rule(coin_logic["Castle of Illusions"], 7, can_bounce)
        add_rule(chest_logic["The Colossal Hole"], grey, can_jump_high, has_sun_medallion)
        add_rule(chest_logic["The Colossal Hole"], green, _has("Fire Form"), _has("Zombie Form"))
        add_rule(chest_logic["The Colossal Hole"], blue, can_jump_high, has_sun_medallion)
        add_rule(key_logic["The Colossal Hole"], grey, can_jump_high, has_sun_medallion)
        add_rule(key_logic["The Colossal Hole"], green,  _has("Fire Form")) 
        add_rule(key_logic["The Colossal Hole"], blue, can_jump_high, has_sun_medallion)
        add_rule(coin_logic["The Colossal Hole"], 0, can_jump_high, has_sun_medallion) 
        add_rule(coin_logic["The Colossal Hole"], 1, can_jump_high, has_sun_medallion) 
        add_rule(coin_logic["The Colossal Hole"], 2, can_jump_high, has_sun_medallion) 
        # add_tf(coin_logic["The Colossal Hole"], 3, _has("Flat Form"), _has("Roll Form")) # uncomment if omodonmeka are randomized
        add_rule(coin_logic["The Colossal Hole"], 4, can_jump_high, has_sun_medallion) 
        add_rule(coin_logic["The Colossal Hole"], 6, can_jump_high, has_sun_medallion) 
        add_rule(key_logic["The Warped Void"], blue, _has("Fat Form"))
        # add_tf(key_logic["The Warped Void"], blue, _c(_has("Fat Form"), _has("Flat Form"))) # uncomment if omodonmeka are randomized
        add_rule(coin_logic["The Warped Void"], 1, can_bounce)
        # add_tf(coin_logic["The Warped Void"], 4, _has("Flat Form", has_vampire_2)) # uncomment if omodonmeka are randomized
        add_rule(key_logic["The East Crater"], green, can_fly)
        add_rule(chest_logic["The East Crater"], blue, can_jump_high) # could have been removed by knowledge check
        add_rule(key_logic["The East Crater"], blue, can_jump_high) # could have been removed by knowledge check
        add_rule(coin_logic["The East Crater"], 0, can_fly)
        add_rule(coin_logic["The East Crater"], 1, can_fly)
        add_rule(coin_logic["The East Crater"], 4, _has("Flat Form"), _has("Roll Form")) # uncomment if omodonmeka are randomized
        add_rule(coin_logic["The East Crater"], 6, _c(can_jump_high, has_grab_1)) # could have been removed by knowledge check
        add_rule(coin_logic["The East Crater"], 7, can_jump_high) # could have been removed by knowledge check
        add_rule(chest_logic["Forest of Fear"], red, can_bounce)
        add_rule(chest_logic["Forest of Fear"], blue, _has("Zombie Form"))
        add_rule(key_logic["Forest of Fear"], red, can_bounce)
        add_rule(key_logic["Forest of Fear"], green, can_fly)
        add_rule(key_logic["Forest of Fear"], blue, can_pass_spikes)
        add_rule(coin_logic["Forest of Fear"], 2, can_bounce)
        add_rule(coin_logic["Forest of Fear"], 3, can_bounce)
        add_rule(coin_logic["Forest of Fear"], 7, can_pass_spikes)
        add_rule(boss_logic, "Shoot", _has("Zombie Form")) # Shoot
        add_rule(boss_logic, "Anonster", can_bounce) # Anonster
        add_rule(boss_logic, "Yellow Belly", can_fly) # Yellow Belly
        ...
        if difficulty < knowledge_checks:
            ...
            add_rule(coin_logic["Desert Ruins"], 7, can_fly)
            # Knowledge: Flying to get around fire for Red Room, bat or flat to get further
            add_rule(chest_logic["Tower of Revival"], red, _c(_has("Fire Form"), _has("Fat Form"), _has("Zombie Form"))) # knowledge: Garlic and Fire
            add_rule(chest_logic["Tower of Revival"], green, _has("Fire Form"))
            add_rule(chest_logic["Tower of Revival"], blue, _c(_has("Fire Form"), _has("Yarn Form"), _has("Flat Form"))) # knowledge: Bat instead of Flat
            add_rule(key_logic["Tower of Revival"], grey, _c(can_fly, _has("Fire Form")))
            add_rule(key_logic["Tower of Revival"], red, _c(_has("Fire Form"), _has("Fat Form"), _has("Zombie Form"))) # knowledge: Garlic and Fire
            add_rule(key_logic["Tower of Revival"], green, _c(_has("Fire Form"),_has("Fat Form")))
            add_rule(key_logic["Tower of Revival"], blue, _has("Fire Form"))
            add_rule(coin_logic["Tower of Revival"], 0, _c(_has("Fire Form"),_has("Flat Form"))) # knowledge: Bat instead of Flat
            add_rule(coin_logic["Tower of Revival"], 1, _has("Fire Form"))
            add_rule(coin_logic["Tower of Revival"], 2, _has("Fire Form"))
            add_rule(coin_logic["Tower of Revival"], 3, _c(_has("Fire Form"),_has("Fat Form")))
            add_rule(coin_logic["Tower of Revival"], 4, _has("Fire Form"))
            add_rule(coin_logic["Tower of Revival"], 5, _c(_has("Fire Form"),_has("Fat Form")))
            add_rule(coin_logic["Tower of Revival"], 6, _c(_has("Fat Form"), _has("Fire Form"), _has("Zombie Form")))
            add_rule(coin_logic["Tower of Revival"], 7, _c(_has("Fire Form"),can_fly))
            ...
            add_rule(key_logic["The Colossal Hole"], grey, can_jump_high, has_sun_medallion)
            add_rule(coin_logic["The Colossal Hole"], 2, can_jump_high, has_sun_medallion, _has("Zombie Form")) 
            add_rule(coin_logic["The Colossal Hole"], 4, can_jump_high, has_sun_medallion) 
        ...
        if difficulty >= knowledge_checks:
            ...
            add_rule(coin_logic["Tower of Revival"], 1, _o(_has("Fire Form"),_c(_o(_has("Flat Form"),has_vampire_2,_has("Roll Form")),can_fly)))
            add_rule(coin_logic["Tower of Revival"], 2, _o(_has("Fire Form"),_c(_o(_has("Flat Form"),has_vampire_2,_has("Roll Form")),can_fly)))
        ...
        if glitches < easy_glitches:
            add_rule(chest_logic["The Steep Canyon"], blue, _has("Fire Form"), _has("Roll Form"))
            add_rule(key_logic["The Steep Canyon"], blue, _has("Fire Form"), _has("Roll Form"))
            add_rule(coin_logic["The Steep Canyon"], 6, _has("Fire Form"), _has("Roll Form"))
            add_rule(coin_logic["The Steep Canyon"], 7, _has("Fire Form"), _has("Roll Form"))

        if glitches >= easy_glitches:
            add_rule(chest_logic["The Steep Canyon"], blue, _has("Fire Form"), _has("Roll Form"), _c(_has("Spiked Helmet"),_has("Flat Form")))
            add_rule(key_logic["The Steep Canyon"], blue, _has("Fire Form"), _has("Roll Form"), _c(_has("Spiked Helmet"),_has("Flat Form")))
            add_rule(coin_logic["The Steep Canyon"], 6, _has("Fire Form"), _has("Roll Form"), _c(_has("Spiked Helmet"),_has("Flat Form")))
